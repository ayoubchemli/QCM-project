...
class MCQApp(QMainWindow):
    ...
    def complete_registration(self):
        try:
            ...
            # Add the new user to the liststacked_widget
            new_user = {
                "fullname": fullname,
                "email": email,
                "username": username,
    ...
    def handle_login(self):
        try:
            ...
            if not os.path.exists(json_file_path):
                self.show_login_error("No users registered. Please sign up first.")
                return
    ...
    def show_login_error(self, message):
        ...
        # Set popup title and text
        error_popup.setWindowTitle("Login Error")
        error_popup.setText(f"✗ {message}")
    ...
    def login_successful(self, user):
        """Handle successful login and navigate to the home page."""
        try:
            ...
            from homePage import MCQHomePage  # Import your home page class
            # Navigate to the home page with the user data
            self.home_window = MCQHomePage(user)
            self.home_window.show()
            self.close()

        except Exception as e:
            self.show_login_error(f"Failed to load home page: {str(e)}")
